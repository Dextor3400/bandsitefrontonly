    ...
    <div class="container">
        ...
        <div class="col-md-8 col-lg-6 mx-auto">
            <form method="POST" action="" enctype="multipart/form-data">
                <div class="mb-4 ">
                    <img width="200px" src="/images/user-profile-picture.jpg" alt="user-profile-image">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="username" class="form-control" value="Your Username">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" class="form-control" value="Your Email">
                </div>
                <div class="form-group">
                    <label for="password">Password</label>
                    <input type="password" name="password" class="form-control" value="Your Username">
                </div>

                <div class="form-group">
                    <label for="password_confirmation">Confirm Password</label>
                    <input type="password" name="password_confirmation" class="form-control" value="Your Username">
                </div>
